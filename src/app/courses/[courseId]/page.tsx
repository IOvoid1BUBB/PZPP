...
function getNormalizedId(courseIdParam: string | string[] | undefined) {
...
export default async function CoursePlayerPage({
  ...
  if (!normalizedCourseId) notFound()
  ...
  const activeModule = mockModules.find((m) => m.title === 'Moduł: Relacje i klucze obce') || mockModules[2]
  const activeLesson = activeModule.lessons.find((l) => l.status === 'active')
  const videoTitle = activeLesson ? `${activeModule.title}: ${activeLesson.title}` : 'Relacje i klucze obce: Relacje jeden-do-wielu (FK)'

  const completedPercent = 25

  return (
    <div className="min-h-screen bg-[#efefef] p-6 pb-12 pt-8 md:pt-10">
          ...
          <section className="space-y-4">
            ...
            <div className="rounded-xl border border-[#e5e7eb] bg-white p-5">
              ...
              <div className="mt-3 flex flex-wrap gap-2 rounded-lg border border-[#e5e7eb] bg-[#f8fafc] p-2">
                <button
                  type="button"
                  className="inline-flex items-center justify-center rounded-md bg-white px-2 py-1 text-sm font-semibold hover:bg-[#f3f4f6]"
                >
                  B
                </button>
                <button
                  type="button"
                  className="inline-flex items-center justify-center rounded-md bg-white px-2 py-1 text-sm italic hover:bg-[#f3f4f6]"
                >
                  I
                </button>
                <button
                  type="button"
                  className="inline-flex items-center justify-center rounded-md bg-white px-2 py-1 text-sm font-semibold underline hover:bg-[#f3f4f6]"
                >
                  U
                </button>
                <button
                ...
                <button
                  type="button"
                  className="inline-flex items-center justify-center gap-2 rounded-md bg-white px-2 py-1 text-xs font-medium hover:bg-[#f3f4f6]"
                >
                ...
                <button
                  type="button"
                  className="inline-flex items-center justify-center rounded-md bg-white px-2 py-1 text-sm hover:bg-[#f3f4f6]"
                >
